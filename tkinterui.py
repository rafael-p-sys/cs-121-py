...
def submit_form():
    ...
    if name == "" or age == "" or gender == "" or country == "" or country == "Select Country":
...
tk.Label(frame, text="Full Name:", bg="lightblue", font=("Arial", 12)).grid(row=0, column=0, sticky="w", padx=5, pady=3)
entry_name = tk.Entry(frame, width=30)
entry_name.grid(row=0, column=1, pady=3)

tk.Label(frame, text="Age:", bg="lightblue", font=("Arial", 12)).grid(row=1, column=0, sticky="w", padx=5, pady=3)
entry_age = tk.Entry(frame, width=30)
entry_age.grid(row=1, column=1, pady=3)

tk.Label(frame, text="Gender:", bg="lightblue", font=("Arial", 12)).grid(row=2, column=0, sticky="w", padx=5, pady=3)
...
tk.Label(frame, text="Hobbies:", bg="lightblue", font=("Arial", 12)).grid(row=3, column=0, sticky="nw", padx=5, pady=3)
